...
// RandomScheduler represents info about RandomScheduler
...
func NewRandomScheduler(podQueue chan *v1.Pod, quit chan struct{}) RandomScheduler {
...
// ScheduleOne gets pod from channel and tries to bind it to a node
func (s *RandomScheduler) ScheduleOne() {
...
func (s *RandomScheduler) bindPod(p *v1.Pod, node string) error {
...
func (s *RandomScheduler) emitEvent(p *v1.Pod, message string) error {
...
func (s *RandomScheduler) runPredicates(nodes []*v1.Node, pod *v1.Pod) []*v1.Node {
...
func (s *RandomScheduler) predicatesApply(node *v1.Node, pod *v1.Pod) bool {
...
func (s *RandomScheduler) findBestNode(priorities map[string]int) string {
	var maxP int
	var bestNode string
