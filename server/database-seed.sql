CREATE TABLE users(username VARCHAR(30) PRIMARY KEY, password VARCHAR(50), email VARCHAR(50), full_name VARCHAR(100), city_address VARCHAR(100), birth_date VARCHAR(30), joined_date TIMESTAMPTZ, 
